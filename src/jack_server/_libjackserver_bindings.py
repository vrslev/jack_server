...
] = _lib.jackctl_parameter_get_type
jackctl_parameter_get_type.argtypes = [POINTER(jackctl_parameter_t)]
jackctl_parameter_get_type.restype = c_uint

jackctl_parameter_get_name: Callable[[Any], bytes] = _lib.jackctl_parameter_get_name
...
jackctl_parameter_set_value: Callable[
    [Any, Any], bool
] = _lib.jackctl_parameter_set_value
...
] = _lib.jackctl_parameter_get_value
...
jackctl_driver_get_parameters: Callable[[Any], Any] = _lib.jackctl_driver_get_parameters
jackctl_driver_get_parameters.argtypes = [POINTER(jackctl_driver_t)]
jackctl_driver_get_parameters.restype = POINTER(JSList)

jackctl_driver_get_name: Callable[[Any], bytes] = _lib.jackctl_driver_get_name
...
jackctl_server_stop: Callable[[Any], bool] = _lib.jackctl_server_stop
jackctl_server_stop.argtypes = [POINTER(jackctl_server_t)]
jackctl_server_stop.restype = c_bool

jackctl_server_close: Callable[[Any], bool] = _lib.jackctl_server_close
